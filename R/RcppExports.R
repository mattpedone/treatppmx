...
mvn_ppmx <- function(iter, burn, thin, nobs, ncon, ncat, catvec, alpha, CC, consim, similarity, calibration, y, xcon, xcat, similparam, hP0_m0, hP0_L0, hP0_nu0, hP0_V0, mhtune) {
    .Call(`_treatppmx_mvn_ppmx`, iter, burn, thin, nobs, ncon, ncat, catvec, alpha, CC, consim, similarity, calibration, y, xcon, xcat, similparam, hP0_m0, hP0_L0, hP0_nu0, hP0_V0, mhtune)
}
