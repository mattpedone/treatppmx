...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(myppmx(iter, burn, thin, nobs, ncon, ncat, catvec, alpha, cohesion, similarity, consim, y, xcon, xcat, npred, xconp, xcatp, similparam, modelpriors, mhtune, calibration));
