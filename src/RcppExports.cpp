...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< arma::vec >::type sigmagrid(sigmagridSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(dm_ppmx_ct(iter, burn, thin, nobs, treatments, PPMx, ncon, ncat, catvec, alpha, sigmagrid, Vwm, cohesion, CC, reuse, consim, similarity, calibration, coardegree, y, z, zpred, noprog, xcon, xcat, xconp, xcatp, npred, similparam, hP0_mu0, hP0_L0, hP0_nu0, hP0_S0, upd_hier, initbeta, hsp, mhtunepar, A, n_a, curr_cluster, card_cluster, ncluster_curr));
