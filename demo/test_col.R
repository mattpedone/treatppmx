...
mbm <- microbenchmark::microbenchmark("byrow" = my_mvn_ppmx(y = Y, X = X, alpha=1, CC = 2, PPMx = 1, similarity = 2, consim=1, calibration=2, 
                               similparam=c(0.0, 1.0, 0.1, 1.0, 2.0, 0.1, 1.0), 
                               modelpriors, mhtune=c(0.5, 0.5), 
                               iter=10,burn=5,thin=1), 
                               "bycol" = my_mvn_ppmx_bycol(y = Y, X = X, alpha=1, CC = 2, PPMx = 1, similarity = 2, consim=1, calibration=2, 
                                           similparam=c(0.0, 1.0, 0.1, 1.0, 2.0, 0.1, 1.0), 
                                           modelpriors, mhtune=c(0.5, 0.5), 
                                           iter=10,burn=5,thin=1), times = 100)
