...
KK <- 1#0
res_1a <- matrix(0, KK, 7)
res_2a <- matrix(0, KK, 7)
res_3a <- matrix(0, KK, 7)
res_4a <- matrix(0, KK, 7)
res_5a <- matrix(0, KK, 7)
#set.seed(121)
K=2

modelpriors <- list()
modelpriors$hP0_m0 <- rep(0, K)
modelpriors$hP0_L0 <- diag(10, K)
modelpriors$hP0_nu0 <- K + 2
modelpriors$hP0_V0 <- diag(10, K)
...
##################
myppmx <- gcd(n=100, concov = 2, K, alpha = 1, similarity = 1, simparm = 1)
