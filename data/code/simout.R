...
nset<-100;
myprob<-list( myprob1, myprob2);    trtsgn<-rep(c(1,2),nsub/2);

# Generate outcomes for replicated dataset
...
mydata<-gene.norm
orgx<-cbind(x2,x3)
#save(myoutot,mytot,mydata,trtsgn, myprob,orgx,myx2,myx3,newx,file="data/SimOutScen1.RData")
